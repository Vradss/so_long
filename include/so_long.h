...
/*   Updated: 2024/09/04 23:12:17 by vflorez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			set_union(t_disjoint_set *s, int adjacent_element, \
int cur_element);
void			union_find(t_disjoint_set *s, t_adjacents relations, \
int cur_element);

//Check collect
t_vec2			*collectibles(char **grid, int count);
void			check_collec(t_aux_map *m, t_disjoint_set *s, t_game *g, \
int target_rep);
